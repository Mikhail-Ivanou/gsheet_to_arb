...
GoogleSheetConfig _$GoogleSheetConfigFromJson(Map<String, dynamic> json) =>
    GoogleSheetConfig(
      ...
      sheetId: (json['sheet_id'] as num).toInt(),
      replaceDots: json['replace_dots'] as bool?,
      camelCase: json['camel_case'] as bool?,
...
Map<String, dynamic> _$GoogleSheetConfigToJson(GoogleSheetConfig instance) =>
    <String, dynamic>{
      ...
      'replace_dots': instance.replaceDots,
      'camel_case': instance.camelCase,
...
SheetColumns _$SheetColumnsFromJson(Map<String, dynamic> json) => SheetColumns(
      ...
      description: (json['description'] as num?)?.toInt() ?? 1,
      first_language_key: (json['first_language_key'] as num?)?.toInt() ?? 2,
    );
...
SheetRows _$SheetRowsFromJson(Map<String, dynamic> json) => SheetRows(
      header_row: (json['header_row'] as num?)?.toInt() ?? 0,
      first_translation_row:
          (json['first_translation_row'] as num?)?.toInt() ?? 1,
    );
